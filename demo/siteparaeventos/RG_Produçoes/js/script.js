...
(function () {
	...
	$(function () {
		...
		// jQuerry Julio COntagem regressiva
		function makeTimer() {

			//		var endTime = new Date("29 April 2018 9:56:00 GMT+01:00");	
				var endTime = new Date("06 October 2022 9:00:00 GMT+03:00");			
					...
					$("#days").html(days + "<spanc>Days</spanc>");
					$("#hours").html(hours + "<spanc>Hours</spanc>");
					$("#minutes").html(minutes + "<spanc>Minutes</spanc>");
					$("#seconds").html(seconds + "<spanc>Seconds</spanc>");		
